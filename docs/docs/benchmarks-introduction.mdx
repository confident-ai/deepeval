...
**Simply follow [this quick guide](guides-using-custom-llms#json-confinement-for-custom-llms) to learn how to generate the correct outputs to benchmark your custom LLM.**
:::
