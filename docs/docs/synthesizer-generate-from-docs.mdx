...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/synthesize-from-docs.svg"
    alt="LangChain"
    style={{
      marginTop: "20px",
      marginBottom: "50px",
...
- [Optional] `context_construction_config`: an instance of type `ContextConstructionConfig` that allows you to [customize the quality of contexts constructed](#customize-context-construction) from your documents. Defaulted to the default `ContextConstructionConfig` values.
