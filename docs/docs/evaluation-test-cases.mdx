...
If you're using Confident AI, the `name` parameter allows you to optionally provide a string identifier to search and filter for your `LLMTestCase`s on Confident AI. This is particularly useful if you're importing test cases from an external datasource.
