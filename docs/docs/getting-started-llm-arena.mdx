...
🎉🥳 **Congratulations!** You have now successfully created an arena test case with the contestants and defined an arena metric. You can now run evals and find the winner of the contestants.
