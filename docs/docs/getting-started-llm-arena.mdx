...
:::tip
If you're looking for a quick way to run arena comparisons, [Confident AI](https://app.confident-ai.com) (DeepEval Cloud) allows you to test different prompts, model, tool, and output configurations **side by side** and evaluate these comparisons using any metrics directly on the platfrom.

<Tabs>
<TabItem value="quick-run" label="Quick Run">

</TabItem>
<TabItem value="experiment" label="Run an Experiment">
