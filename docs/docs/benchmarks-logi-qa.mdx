...
The code below assesses a custom `mistral_7b` model ([click here](guides-using-custom-llms) to learn how to use ANY custom LLM) on categorical reasoning and sufficient conditional reasoning using 3-shot prompting.
