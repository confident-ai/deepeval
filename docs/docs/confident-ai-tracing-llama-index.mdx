...
:::info
LLamaIndex traces are marked with the ![](../assets/llama.png) icon.
:::

import LlamaVideo from "../assets/llama.mp4";

<video src={LlamaVideo} width="100%" autoPlay loop muted playsInline />
