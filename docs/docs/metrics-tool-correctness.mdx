...
metric = ToolCorrectnessMetric(tool_call_param=ToolCallParams.TOOL)
...
- [Optional] `tool_call_param`: a `ToolCallParams` indicating what aspect of tool correctness (tool, input parameters, output) to evaluate.
