...
We recommend using [Confident AI's dataset editor](https://app.confident-ai.com) to curate goldens in bulk, which allows you to edit, annotate, and assign golden creation tasks to your team.
...
Your generated test cases should be populated with simulated `Turn`s.
