...
Navigate to [Confident AI](https://app.confident-ai.com) and create a [metric collection](https://documentation.confident-ai.com/docs/llm-evaluation/metrics/create-on-the-cloud#create-a-metric-collection) with multi-turn metrics.
...
Find the thread ID of the conversation you wish to evaluate and run an evaluation using the metric collection name.
