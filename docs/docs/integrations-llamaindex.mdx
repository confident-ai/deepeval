...
- [Optional] `filtration_config`: an instance of type `FiltrationConfig` that allows you to [customize the degree of which goldens are filtered](synthesizer-introduction#filtration-degree) during generation. Defaulted to the default `FiltrationConfig` values.
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/autoeval_llama.svg"
    style={{
      height: "auto",
      maxHeight: "800px",
      marginTop: "20px",
...
- automatically integrates with [Confident AI](/confident-ai/confident-ai-introduction), which offers evaluation analysis, evaluation debugging, dataset management, and real-time evaluations in production
