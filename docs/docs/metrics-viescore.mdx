...
- [Optional] `model`: a string specifying which of OpenAI's GPT models to use, **OR** [any custom MLLM model](metrics-introduction#using-a-custom-llm) of type `DeepEvalBaseMLLM`. Defaulted to 'gpt-4o'.
