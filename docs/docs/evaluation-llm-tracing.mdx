...
The [`@observe`](#observe) decorator is the primary way to setup tracing for your LLM application. You need to find the individual components of your LLM application and decorate them with `deepeval`'s `@observe` decorator. 
  ...
  items={[
    {
      ...
      description:
        "Learn how to run end-to-end evals with your trace data,",
      icon: "SendToBack",
    ...
    },
    {
      ...
      description:
        "Learn how to run component-level evals using tracing.",
