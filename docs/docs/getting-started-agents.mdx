...
```python title=main.py showLineNumbers={true} wrapLines={true} metastring="{2,16}"
...
```python title=main.py showLineNumbers={true} wrapLines={true} metastring="{2,12}"
...
```python title=main.py showLineNumbers={true} wrapLines={true} metastring="{4}"
...
```python title=main.py showLineNumbers={true} wrapLines={true} metastring="{10,16,19}"
from deepeval.tracing import observe
...
```python title=main.py showLineNumbers={true} wrapLines={true} metastring="{17,20,24}"
from deepeval.integrations.langchain import CallbackHandler
from langgraph.prebuilt import create_react_agent
from deepeval.dataset import EvaluationDataset, Golden
...
...
```python title=main.py showLineNumbers={true} wrapLines={true} metastring="{13,16,20}"
from langchain.chat_models import init_chat_model
from deepeval.integrations.langchain import CallbackHandler
from deepeval.dataset import EvaluationDataset, Golden
...
...
```python title=main.py showLineNumbers={true} wrapLines={true} metastring="{9,13,16}"
from crewai import Task, Crew
from deepeval.dataset import EvaluationDataset, Golden
...
...
```python title=main.py showLineNumbers={true} wrapLines={true} metastring="{14,23,28}"
...
```python title=main.py showLineNumbers={true} wrapLines={true} metastring="{5,8}"
from deepeval.dataset import EvaluationDataset, Golden
...
...
3. **Enable evals in production**: Just replace `metrics` in `@observe` with a [`metric_collection`](https://documentation.confident-ai.com/docs/llm-tracing/evaluations#online-evaluations) string on Confident AI.
