...
<Timeline>
  ...
  <TimelineItem title="Configure environment variables">
    <p>
      ...
      <a href="https://documentation.confident-ai.com/docs/llm-tracing/evaluations#online-evaluations">
...
<Timeline>
  <TimelineItem title="Configure metrics">
    ...
    <details>
      ...
      <p>Other metrics on DeepEval can also be used to evaluate agents but <strong>ONLY</strong> if you run <a href="/docs/getting-started-agents#component-level-evaluations">component-level evaluations</a>, since they require you to set up an LLM test case. These metrics include:</p>
      <ul>
        <li><a href="/docs/metrics-tool-correctness">Tool Correctness</a></li>
        <li><a href="/docs/metrics-llm-evals">G-Eval</a></li>
        <li><a href="/docs/metrics-answer-relevancy">Answer Relevancy</a></li>
        <li><a href="/docs/metrics-faithfulness">Faithfulness</a></li>
      </ul>
      <p>For more information on available metrics, see the <a href="/docs/metrics-introduction">Metrics Introduction</a> section.</p>
    </details>
    <Tabs>
      <TabItem value="python" label="Python">
        <p>
...
<Timeline>
  <TimelineItem title="Set up test cases">
    <p>
      ...
      about available <a href="evaluation-test-cases">test case parameters here.</a></p>
    <CodeBlock
      className="language-python"
      title="main.py"
      showLineNumbers={true}
