...
:::info
[Click here for a full end-to-end tutorial](tutorial-metrics-defining-an-evaluation-criteria) on `deepeval`, which includes an entire walkthrough of how to pick the right LLM evaluation metrics for yourself.
:::
