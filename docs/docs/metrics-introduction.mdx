...
:::info DID YOU KNOW?
[Click here for a full end-to-end tutorial](/tutorials/tutorial-metrics-defining-an-evaluation-criteria) on `deepeval`, which includes an entire walkthrough of how to pick the right LLM evaluation metrics for yourself.
:::
