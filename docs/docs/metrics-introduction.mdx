...
:::tip
Not sure which metrics are suitable for your use case? Run the follow command to find out:
...
:::note
Before getting started, make sure your [Ollama model](https://ollama.com/search) is installed and running.
...
:::tip
[Visit Ollama](https://ollama.com/search) to see the full list of **available models**.
:::

Optionally, you can specify the **base URL** of your local Ollama model instance if you've defined a custom port. The default base URL is set to `http://localhost:11434/v1/`.
