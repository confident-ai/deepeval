...
:::info
An [experiment](confident-ai-testing-n-evaluation-experiments) in Confident AI is a collection of metrics that you can use to **benchmark your LLM in a contained way**. Running an experiment produces a test run, which contains the evaluation results of your LLM app's test cases.
:::
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/01_choose_metrics.svg"
    alt="Langchain"
    style={{
      marginTop: "20px",
      marginBottom: "20px",
...
:::tip
To learn more about test cases and their parameters in DeepEval, visit [this section](evaluation-test-cases).
:::
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/02_choose_metrics.svg"
    alt="Langchain"
    style={{
      marginTop: "20px",
      marginBottom: "20px",
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/03_choose_metrics.svg"
    alt="Langchain"
    style={{
      marginTop: "20px",
      marginBottom: "20px",
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/04_choose_metrics.svg"
    alt="Langchain"
    style={{
      marginTop: "20px",
      marginBottom: "20px",
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/05_choose_metrics.svg"
    alt="Langchain"
    style={{
      marginTop: "20px",
      marginBottom: "20px",
