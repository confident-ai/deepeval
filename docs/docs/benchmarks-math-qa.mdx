...
The code below assesses a custom `mistral_7b` model ([click here](guides-using-custom-llms) to learn how to use ANY custom LLM) on geometry and probability in `MathQA` using 3-shot prompting.
