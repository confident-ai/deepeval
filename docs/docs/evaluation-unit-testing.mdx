...
Create a YAML file to execute your test file automatically in CI/CD pipelines. [Click here for an example YAML file](#run-unit-tests-for-every-push).
