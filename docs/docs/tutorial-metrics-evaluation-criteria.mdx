...
```python
user_query = """
  My nose has been running constantly. Could it be something serious?
"""
llm_output = """
   It’s probably nothing to worry about. Most likely just allergies or a cold. Don’t overthink it.
"""
```
