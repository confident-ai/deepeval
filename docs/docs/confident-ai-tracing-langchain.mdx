...
:::info
LangChain traces are marked with the ![](../assets/Langchain.png) icon.
:::

import LangChainVideo from "../assets/langchain.mp4";

<video src={LangChainVideo} width="100%" autoPlay loop muted playsInline />
