...
The Exact Match metric measures whether your LLM application's `actual_output` exactly matches the `expected_output`. The outputs must be same for the metric to pass.
