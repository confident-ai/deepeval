...
answer_relevancy = AnswerRelevancyMetric(threshold=0.8, model="gpt-4.1")
contextual_precision = ContextualPrecisionMetric(threshold=0.8, model="gpt-4.1")
```
...
contextual_precision = ContextualPrecisionMetric(threshold=0.8, model=model)
```
