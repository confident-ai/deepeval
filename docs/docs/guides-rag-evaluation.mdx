...
_(To evaluate generation on customized criteria, you should use the [`GEval`](metrics-llm-evals) metric instead, which covers all custom use cases.)_
...
You can visit the [`GEval` page](metrics-llm-evals) to learn more about this metric.
