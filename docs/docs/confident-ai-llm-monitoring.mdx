...
- `event_name`: type `str` specifying the type of event monitored. The `event_name` can be thought of as an identifier for different functionalities your LLM application performs.
