...
```python
from deepeval.optimizer.gepa.configs import GEPAConfig
...
from deepeval.optimizer.adapters.deepeval_scorer import (
    DeepEvalScoringAdapter,
)
from deepeval.optimizer.aggregates import median_of_all
from deepeval.optimizer.gepa.configs import GEPAConfig
