...
[Confident AI](https://confident-ai.com) is the umbrella cloud platform for LLM evaluation, red teaming, observability, and monitoring. Both DeepEval and [DeepTeam](https://trydeepteam.com) are open-source frameworks that also serve as **SDKs for Confident AI** — they integrate via APIs so that evaluation results, red teaming assessments, and traces all flow into the same platform.
...
- **[Confident AI](https://confident-ai.com)** is the cloud platform — evaluation, red teaming, observability, monitoring, and collaboration all live here.
- **[DeepEval](https://github.com/confident-ai/deepeval)** is the open-source LLM evaluation framework and one of the SDKs for Confident AI.
- **[DeepTeam](https://trydeepteam.com)** is the open-source LLM red teaming framework and another SDK for Confident AI.
