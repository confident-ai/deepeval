...
title: Generating More Test Cases
sidebar_label: Generating More Test Cases
---
...
In this tutorial, we’ll demonstrate how to generate **synthetic datasets** for our medical chatbot using 2 aproaches:

- [Generating from Documents](#generating-synthetic-data-from-documents)
- [Generating from Scratch](#generating-synthetic-data-from-scratch)
