...
- [Generate test data from existing documents](#generating-synthetic-data-from-documents)
- [Generate test data without context](#generating-synthetic-data-from-scratch)
