...
When scanning your target model, instead of defining a list of vulnerabilities individually, you can optionally supply a list of `LLMRisk`, which will automatically scan for all the vulnerability types within that risk category.


```python
from deepeval.vulnerability import LLMRisk
...
results = red_teamer.scan(
    ...
    vulnerabilities=[LLMRisk.RESPONSIBLE_AI]
)```
