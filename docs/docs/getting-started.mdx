...
## Evaluate Your First Dataset in Bulk
...
Utilize the `@pytest.mark.parametrize` decorator to loop through and evaluate your dataset on an entire evaluation dataset.
