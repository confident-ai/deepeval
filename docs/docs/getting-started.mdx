...
Additionally, DeepEval integrates natively with [Confident AI](https://app.confident-ai.com), which allows anyone to **evaluate, regression test, and monitor** LLM applications on the cloud.
