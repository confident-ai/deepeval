...
Confident AI allows anyone to define (custom) LLM evaluation metrics and run evaluations scalably on the cloud.

All you need to do is [create an experiment on Confident AI](confident-ai-testing-n-evaluation-experiments#creating-an-experiment) and send over test cases that you wish to be evaluated. All compute and LLMs required for evaluation will be provided by Confident AI.
