...
<img src={ASSETS.llmTestCase} alt="LLM Test Case" />
...
<img src={ASSETS.componentLevelEvals} alt="component level evals" />
  ...
  items={[
    {
      title: "Confident AI",
      description:
        "An AI quality platform with observability, evals, and monitoring. DeepEval integrates with it natively, letting technical and non-technical teams collaborate on testing AI from /dev to /prod.",
      icon: "Cloud",
      to: "https://www.confident-ai.com/docs?utm_source=deepeval&utm_medium=docs&utm_content=other_products_card&ref_page=/docs/getting-started",
    },
    {
      title: "DeepTeam",
      description:
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          , an AI quality platform with observability, evals, and monitoring,
          but using DeepEval does not require Confident AI.
        </>
      ),
    },
    {
      ...
      answer:
        "RAG pipelines, agents, chatbots, summarization, structured outputs, multi-modal apps — and virtually any other LLM use case. DeepEval ships 50+ research-backed metrics and lets you define fully custom ones.",
    },
    {
