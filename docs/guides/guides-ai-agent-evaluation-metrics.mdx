...
# Initialize metric
plan_quality = PlanQualityMetric(threshold=0.7, model="claude-3-7-sonnet-latest")
...
# Initialize metric
plan_adherence = PlanAdherenceMetric(threshold=0.7, model="claude-3-7-sonnet-latest")
...
# Initialize metric
argument_correctness = ArgumentCorrectnessMetric(threshold=0.7, model="claude-3-7-sonnet-latest")
...
task_completion = TaskCompletionMetric(threshold=0.7, model="claude-3-7-sonnet-latest")
...
# Initialize metric
step_efficiency = StepEfficiencyMetric(threshold=0.7, model="claude-3-7-sonnet-latest")
