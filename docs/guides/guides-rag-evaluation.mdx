...
:::note
You can learn about everything `deepeval test run` has to offer [here (including parallelization, caching, error handling, etc.).](/docs/evaluation-introduction#evaluating-with-pytest)
:::
