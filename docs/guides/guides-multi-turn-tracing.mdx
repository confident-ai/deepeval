---
id: guides-multi-turn-tracing
title: Tracing Multi-Turn Applications
sidebar_label: Tracing Chatbots
---

<head>
  <link
    rel="canonical"
    href="https://deepeval.com/guides/guides-multi-turn-observability"
  />
</head>
...
:::note
This guide assumes you have already configured the global trace manager. If you haven't, start with the [Tracing RAG Applications guide](/guides/guides-tracing-rag) to set up `trace_manager.configure()` before continuing.
:::
...
<Timeline>
<TimelineItem title="Create a multi-turn metric collection">
...
<TimelineItem title="Attach the collection to your trace">
...
<TimelineItem title="Monitor conversational drift">
