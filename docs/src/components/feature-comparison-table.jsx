  ...
  ragas: {
    metrics: [
      ...
      },
      {
        ...
        description: 'Metrics for LLM safety and security like bias, PII leakage',
        deepeval: true,
        competitor: false,
      },
      {
      ...
      },
      {
        ...
        description: 'Custom LLM judges can be forced to output valid JSON for metrics',
        deepeval: true,
        competitor: false,
      },
      {
    ...
    synthesizer: [
      ...
      },
      {
        ...
        description: 'Generate in français, español, deutsch, italiano, 日本語, etc.',
        deepeval: true,
        competitor: false,
      },
      {
    ...
    redTeaming: [
      {
        ...
        description: 'Vulnerabilities such as bias, toxicity, misinformation, etc.',
        deepeval: true,
        competitor: false,
      },
      {
    ...
    integrations: [
      ...
      },
      {
        ...
        description: 'Run evals within the Lang ecosystem, or apps built with it',
        deepeval: true,
        competitor: true,
      },
      {
        feature: 'LlamaIndex',
        description: 'Run evals within the LlamaIndex ecosystem, or apps built with it',
        deepeval: true,
        competitor: true,
      },
      {
    ...
    platform: [
      ...
      },
      {
        ...
        description: 'Comprehensive reports that can be shared with stakeholders',
        deepeval: true,
        competitor: false,
      },
      {
      ...
      },
      {
        ...
        description: 'Score distributions, mean, median, standard deviation, etc.',
        deepeval: true,
        competitor: false,
      },
      {
        feature: 'Metric validation',
        description: 'False positives, false negatives, confusion matrices, etc.',
        deepeval: true,
        competitor: false,
      },
      {
      ...
      },
      {
        ...
        description: 'Pings your slack, teams, discord, after each evaluation run.',
        deepeval: true,
        competitor: false,
      },
      {
      ...
      },
      {
        ...
        description: 'Custom roles, permissions, data segregation for different teams',
        deepeval: true,
        competitor: false,
      },
      {
...
export default function FeatureComparisonTable({ type, competitor }) {
  ...
  const renderValue = (value) => {
    ...
    return value ?  <img alt='yes' src="/icons/tick.svg" className={styles.tick}/> : <img alt='no' src="/icons/cross.svg" className={styles.cross}/>
  }
        ...
        <div>
          {data.map((item, idx) => (
            <div key={idx} className={styles.featureRow}>
              ...
              <div className={styles.centeredCell}>{renderValue(item.deepeval)}</div>
              <div className={styles.centeredCell}>{renderValue(item.competitor)}</div>
            </div>
          ))}
        </div>
      </div>
