...
const OpenAIMark: React.FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg viewBox="0 0 721 721" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
...
const VercelAISDKMark: React.FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg viewBox="0 -17 256 256" fill="currentColor" preserveAspectRatio="xMidYMid" xmlns="http://www.w3.org/2000/svg" {...props}>
...
const CircleCIMark: React.FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg viewBox="0 0 256 259" fill="currentColor" preserveAspectRatio="xMidYMid" xmlns="http://www.w3.org/2000/svg" {...props}>
...
const GitHubMark: React.FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg viewBox="0 0 128 128" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
