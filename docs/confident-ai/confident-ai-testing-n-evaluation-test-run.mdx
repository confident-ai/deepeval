...
In short, a test run is a benchmark for your LLM application, and you can also think of LLM evaluation with Confident AI and `deepeval` as unit-testing for LLMs.
