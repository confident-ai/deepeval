...
:::info
LLamaIndex traces are marked with the LlamaIndex icon <img src="https://deepeval-docs.s3.amazonaws.com/llama.svg" alt="LlamaIndex" width="18px"/>.
:::

<video width="100%" autoPlay loop muted playsInlines>
  <source
    src="https://deepeval-docs.s3.amazonaws.com/llama.mp4"
    type="video/mp4"
  />
</video>
