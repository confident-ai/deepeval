...
:::info
Feedback can be accessed, reviewed, and filtered on the **[Human Feedback page](/confident-ai/confident-ai-human-feedback-platform)** by data annotators, labelers, and domain experts for further discussion, including the potential inclusion of an response in the dataset.
:::
...
![ok](https://deepeval-docs.s3.amazonaws.com/inspect_event.svg)
...
![ok](https://deepeval-docs.s3.amazonaws.com/leave_feedback.svg)
...
![ok](https://deepeval-docs.s3.amazonaws.com/feedback_left.svg)
