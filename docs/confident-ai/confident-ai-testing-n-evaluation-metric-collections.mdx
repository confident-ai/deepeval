...
<video width="100%" controls muted playsInline>
  <source
    src="https://deepeval-docs.s3.us-east-1.amazonaws.com/confident-metric-collections.mp4"
    type="video/mp4"
  />
</video>
...
<video width="100%" controls muted playsInline>
  <source
    src="https://deepeval-docs.s3.us-east-1.amazonaws.com/confident-metric-glossary.mp4"
    type="video/mp4"
  />
</video>
