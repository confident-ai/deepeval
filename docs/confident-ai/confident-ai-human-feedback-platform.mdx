...
![ok](https://deepeval-docs.s3.amazonaws.com/human_feedback.svg)
...
![ok](https://deepeval-docs.s3.amazonaws.com/human_feedback_filter.svg)

### 3. Viewing Filtered Feedback

For example, you can view all 1-star rated feedback to analyze areas that need improvement.

![ok](https://deepeval-docs.s3.amazonaws.com/human_feedback_filtered.svg)
