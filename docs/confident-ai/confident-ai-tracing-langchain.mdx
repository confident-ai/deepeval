...
:::info
LangChain traces are marked with the LangChain icon <img src="https://deepeval-docs.s3.amazonaws.com/langchain.svg" alt="LangChain" width="30px"/>.
:::

<video width="100%" autoPlay loop muted playsInlines>
  <source
    src="https://deepeval-docs.s3.amazonaws.com/langchain.mp4"
    type="video/mp4"
  />
</video>
