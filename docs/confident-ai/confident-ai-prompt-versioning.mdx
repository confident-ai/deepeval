...
Manging your prompts manually is a messy process and introduces a lot of ad-hoc interation that are often times counter-productive. Iterating without versioning your prompt is arguebly just as bad a deploying to production without first running evaluations.
