...
:::info
An [experiment](/confident-ai/confident-ai-testing-n-evaluation-experiments) in Confident AI is a collection of metrics that you can use to **benchmark your LLM in a contained way**. Running an experiment produces a test run, which contains the evaluation results of your LLM app's test cases.
:::
