...
:::caution
Although we've pre-computed the generated outputs and retrieval context, you will need to populate these fields at evaluation time by running the function that calls your LLM application (e.g. `chatbot.generate(..)`).
:::
