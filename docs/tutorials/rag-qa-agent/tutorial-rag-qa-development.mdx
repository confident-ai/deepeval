...
:::note
If you already have an RAG application that you want to evaluate, feel free to skip to the [**evaluation section of this tuorial**](/tutorials/rag-qa-agent/tutorial-rag-qa-evaluation).
:::
