...
<img src={ASSETS.llmTestCase} alt="Single-turn LLM Test Case" />
...
<img src={ASSETS.evaluationDataset} alt="Evaluation Dataset" />
...
<img src={ASSETS.tutorialSummarizationEvalResults} alt="Eval results for summarizer" />
