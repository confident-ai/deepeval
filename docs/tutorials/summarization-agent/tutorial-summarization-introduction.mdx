...
The above image shows what you might see on the webpage of your meeting summarization platform. **It includes the meeting overview, full transcript, summary, and action items relevant to everyone involved.**
