...
<LinkCards
    tutorials={[
        {
            title: 'Development',
            description: 'Click here to move to the development stage of the summarization agent.',
            to: '/tutorials/summarization-agent/tutorial-summarization-development',
        },
        {
            title: 'Evaluation',
            description: 'Click here to move to the evaluation stage of the summarization agent.',
            to: '/tutorials/summarization-agent/tutorial-summarization-evaluation',
        },
        {
            title: 'Improvement',
            description: 'Click here to move to the improvement stage of the summarization agent.',
            to: '/tutorials/summarization-agent/tutorial-summarization-improvement',
        },
        {
            title: 'Production',
            description: 'Click here to move to the production stage of the summarization agent.',
...
:::info
We'll be using `gpt-3.5` to power our LLM summarizer. Here's the prompt template used to guide the model's summaries:
```text
