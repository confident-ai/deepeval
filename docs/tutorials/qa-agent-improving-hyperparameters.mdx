...
>
  <video width="100%" autoPlay loop muted playsInlines>
    <source
      src="https://confident-docs.s3.us-east-1.amazonaws.com/qa-agent-ran-evaluation.mp4"
      type="video/mp4"
    />
  </video>
</div>
...
>
  <video width="100%" autoPlay loop muted playsInlines>
    <source
      src="https://confident-docs.s3.us-east-1.amazonaws.com/qa-agent-reran-evaluation.mp4"
      type="video/mp4"
    />
  </video>
</div>
