...
>
  <video width="100%" autoPlay loop muted playsInlines>
    <source
      src="https://confident-docs.s3.us-east-1.amazonaws.com/tutorial-legal-document-summarizer-creating-a-dataset.mp4"
      type="video/mp4"
    />
  </video>
</div>
...
>
  <video width="100%" autoPlay loop muted playsInlines>
    <source
      src="https://confident-docs.s3.us-east-1.amazonaws.com/tutorial-legal-document-summarizer-editing-dataset.mp4"
      type="video/mp4"
    />
  </video>
</div>
