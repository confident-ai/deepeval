...
Since OpenAI models wasn't train specifically on medical knowledge, we'll need to leverage RAG to provide additional context at runtime to diagnose patients that are grounded in context.
...
class MedicalChatbot:
    ...
    def setup_agent(self):
        ...
        # Create agent
        tools = [self.retrieve_knowledge, self.create_appointment]
