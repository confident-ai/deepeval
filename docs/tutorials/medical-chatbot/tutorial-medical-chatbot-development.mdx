...
:::note
If you already have an multi-turn chatbot that you want to evaluate, feel free to skip to the [**evaluation section of this tuorial**](/tutorials/medical-chatbot/tutorial-medical-chatbot-evaluation).
:::
...
class MedicalChatbot:
    ...
    def setup_agent(self, system_prompt: str):
        ...
        system_prompt = system_prompt or (
            "You are BayMax, a personal heathcare companion, answer the user's concerns in an empathetic way."
