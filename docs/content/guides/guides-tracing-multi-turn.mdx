...
:::note
The integrations shown here focus on thread stitching. For full options — including attaching multi-turn metric collections, adding tags and metadata, and monitoring threads in Confident AI — see the dedicated integration docs for [LangGraph](/integrations/frameworks/langgraph), [Pydantic AI](/integrations/frameworks/pydanticai), [CrewAI](/integrations/frameworks/crewai), and [LlamaIndex](/integrations/frameworks/llamaindex).
:::
