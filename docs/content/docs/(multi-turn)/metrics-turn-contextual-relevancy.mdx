...
const metric = new metrics.TurnContextualRelevancyMetric({ threshold: 0.5 });
  ...
  qas={[
    {
      ...
      answer: (
        <>
          ...
          <code>retrieval_context</code> signal-to-noise measured in context.
          The single-turn{" "}
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          turn's <code>retrieval_context</code> is relevant to the user's input
