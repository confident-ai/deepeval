...
const metric = new metrics.TopicAdherenceMetric({ relevantTopics: ["..."], threshold: 0.5 });
  ...
  qas={[
    {
      ...
      answer: (
        <>
          Define allowed topics in <code>relevant_topics</code> and run{" "}
    ...
    },
    {
      ...
      answer: (
        <>
          No — refusing a question outside <code>relevant_topics</code> is a
    ...
    {
      question: "What should I put in `relevant_topics`?",
      answer: (
        <>
