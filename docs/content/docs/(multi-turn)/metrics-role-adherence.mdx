...
const metric = new metrics.RoleAdherenceMetric({ threshold: 0.5 });
  ...
  qas={[
    {
      ...
      answer: (
        <>
          ...
          turn against your <code>chatbot_role</code> using prior turns as
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          bot held its <code>chatbot_role</code>.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          Only assistant turns — those that stayed in <code>chatbot_role</code>{" "}
    ...
    {
      question: "What should `chatbot_role` contain?",
      answer: (
        <>
