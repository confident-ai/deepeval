...
const metric = new metrics.TurnRelevancyMetric({ threshold: 0.5 });
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          turns ago counts as irrelevant. Use <code>verbose_mode</code> to see
          which window dragged the score down.
        </>
      ),
    },
    {
      question: "What does `window_size` control and when should I change it?",
      answer: (
        <>
          <code>window_size</code> (default <code>10</code>) sets how many recent
