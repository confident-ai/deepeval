...
Your generated test cases should be populated with simulated `Turn`s, along with the `scenario`, <Term py="expected_outcome" ts="expectedOutcome"/>, and the user's profile from the conversation golden.
