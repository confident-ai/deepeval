...
:::info
Run [`deepeval set-mode experimental`](/docs/command-line-interface#set-mode) to have the judgement nodes decided by [Jev](/integrations/models/typesafe-ai), TypeSafe AI's System One model, instead. You'll need to set `TYPESAFE_API_KEY` and [install the SDK](/integrations/models/typesafe-ai#setting-up).
:::
