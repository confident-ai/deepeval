...
const metric = new metrics.ConversationalGEval({
  name: "Professionalism",
  criteria: "Determine whether the assistant has acted professionally based on the content.",
  ...
  qas={[
    {
      ...
      answer: (
        <>
          ...
          <code>input</code>/<code>actual_output</code> pair and can't reason
          across turns.
        </>
      ),
    },
    ...
    {
      question: "Which turn parameters should I put in `evaluation_params`?",
      answer: (
        <>
          Only the parameters you want evaluated. Include just the fields your{" "}
          <code>criteria</code>/<code>evaluation_steps</code> reference (e.g.{" "}
