...
const metric = new metrics.HallucinationMetric({ threshold: 0.5 });
  ...
  qas={[
    {
      ...
      answer: (
        <>
          ...
          the source of truth is the <code>retrieval_context</code> your
          retriever fetched.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          ...
          contradict the <code>actual_output</code>, so 0 is perfect.{" "}
          <code>threshold</code> is therefore a <em>maximum</em> — output passes
          at or below it. <code>strict_mode</code> forces the threshold to 0.
        </>
      ),
    },
    {
      question:
        "It compares against `context`, not `retrieval_context` — what's the difference?",
      answer: (
        <>
          <code>context</code> is ground-truth reference material you supply;{" "}
          <code>retrieval_context</code> is what your retriever fetched. This
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <code>retrieval_context</code> instead.
        </>
      ),
    },
  ]}
