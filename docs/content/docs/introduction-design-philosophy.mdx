...
DeepEval was designed around a simple idea: evaluation should fit the way your team actually iterates.
...
<ImageDisplayer src={ASSETS.deepevalTuiInspect} alt="deepeval inspect TUI showing a trace tree with per-span scores and metric reasons" />
