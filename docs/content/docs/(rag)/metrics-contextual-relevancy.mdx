...
const metric = new metrics.ContextualRelevancyMetric({
  threshold: 0.7,
  model: "gpt-4.1",
  includeReason: true,
});
  ...
  qas={[
    {
      ...
      answer: (
        <>
          ...
          of statements in <code>retrieval_context</code> relevant to the{" "}
    ...
    },
    {
      ...
      answer: (
        <>
          Too much irrelevant material in your <code>retrieval_context</code>.
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          retriever via <code>retrieval_context</code>, while{" "}
          <a href="/docs/metrics-answer-relevancy">Answer Relevancy</a> grades
          your generator via <code>actual_output</code>. Clean context with an
    ...
    },
    {
      ...
      answer: (
        <>
          No. It's referenceless — judging <code>retrieval_context</code> purely
          against the <code>input</code> with no <code>expected_output</code>,
