...
<FAQs
  qas={[
    ...
    },
    {
      ...
      answer: (
        <>
          Use <code>BiasMetric</code> for prejudiced treatment of groups, and the{" "}
          <a href="/docs/metrics-toxicity">
            <code>ToxicityMetric</code>
          </a>{" "}
          for hostile tone like insults and threats. An output can be one without
          the other, so suites often run both.
        </>
      ),
    },
  ]}
