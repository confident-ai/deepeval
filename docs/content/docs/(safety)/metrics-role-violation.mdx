...
const metric = new metrics.RoleViolationMetric({ role: "helpful customer service agent", threshold: 0.5 });
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          on one <code>actual_output</code>, while Role Adherence evaluates
