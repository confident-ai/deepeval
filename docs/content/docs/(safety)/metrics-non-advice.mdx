...
const metric = new metrics.NonAdviceMetric({ adviceTypes: ["financial", "medical"], threshold: 0.5 });
  ...
  qas={[
    {
      ...
      answer: (
        <>
          Set the required <code>advice_types</code> argument, e.g.{" "}
          <code>advice_types=["medical"]</code> or{" "}
          <code>advice_types=["financial", "legal"]</code>. It only flags advice
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <code>include_reason</code> to see how each was judged.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          ...
          inappropriate advice within your <code>advice_types</code>, while the{" "}
