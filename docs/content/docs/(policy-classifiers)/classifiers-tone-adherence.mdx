...
There are **EIGHT** optional parameters when creating a `ToneAdherenceClassifier`:
...
You can change how the `ToneAdherenceClassifier` is calculated by setting the [eval mode](/docs/evaluation-eval-modes).
