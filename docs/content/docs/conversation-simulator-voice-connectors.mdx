...
There are **THREE** mandatory and **SIX** optional parameters when creating a `LiveKitConnector`. The three mandatory connection values can instead come from the environment:
