...
The Exact Match metric measures whether your LLM application's <Term py="actual_output" ts="actualOutput"/> matches the <Term py="expected_output" ts="expectedOutput"/> exactly.
...
There are **THREE** optional parameters when creating an `ExactMatchMetric`:
...
The `ExactMatchMetric` performs a strict equality check to determine if the <Term py="actual_output" ts="actualOutput"/> matches the <Term py="expected_output" ts="expectedOutput"/>.
  ...
  qas={[
    {
      ...
      answer: (
        <>
          ...
          between <Term py="actual_output" ts="actualOutput"/> and <Term py="expected_output" ts="expectedOutput"/> —
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <Term py="verbose_mode=True" ts="verboseMode: true"/> to print the compared strings and spot
