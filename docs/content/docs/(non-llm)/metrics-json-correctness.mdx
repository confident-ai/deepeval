...
const metric = new metrics.JsonCorrectnessMetric({
  ...
  qas={[
    {
      ...
      answer: (
        <>
          ...
          <code>actual_output</code> loads into your <code>expected_schema</code>.
          The <code>model</code> only <em>generates the reason</em> on invalid
          schemas when <code>include_reason</code> is <code>True</code>; set{" "}
          <code>include_reason=False</code> to skip it.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          ...
          <code>include_reason</code> is <code>True</code>.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          ...
          — and pass it as the <code>expected_schema</code>.
        </>
      ),
    },
    {
