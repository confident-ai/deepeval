...
- Use 50+ ready-to-use metrics, including LLM-as-a-judge, Jev-as-a-judge, agent, tool-use,
  conversational, voice, safety, RAG, and multimodal metrics.
- Evaluate AI agents, conversational agents (chatbots), voice AI, RAG pipelines, MCP systems, and
