...
## What can DeepEval do for you?

Apart from building evaluation pipelines with DeepEval, DeepEval's CLI evaluation capabilities make it one of the best eval harnesses for five coding agents such as Claude Code, Codex, and Cursor.

The diagram below explains how DeepEval can take part in your iteration cycles, not just as a final validation.
