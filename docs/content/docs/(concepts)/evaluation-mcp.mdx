...
```typescript title="main.ts"
import { MCPServer } from "deepeval/testCase";
...
```typescript title="main.ts"
import { Client } from "@modelcontextprotocol/sdk/client/index.js";
import { MCPToolCall } from "deepeval/testCase";
...
```typescript title="main.ts"
import { Client } from "@modelcontextprotocol/sdk/client/index.js";
import { MCPResourceCall } from "deepeval/testCase";
...
```typescript title="main.ts"
import { Client } from "@modelcontextprotocol/sdk/client/index.js";
import { MCPPromptCall } from "deepeval/testCase";
...
const testCase = new LLMTestCase({
  ...
  mcpToolsCalled: [new MCPToolCall({ name: "...", args: {}, result: "..." })],
  mcpPromptsCalled: [new MCPPromptCall({ name: "...", result: "..." })],
  mcpResourcesCalled: [new MCPResourceCall({ uri: "...", result: "..." })],
});

// Run evaluations
await evaluate([testCase], [new metrics.MCPUseMetric()]);
```
...
```typescript title="main.ts"
import { ConversationalTestCase, MCPServer } from "deepeval/testCase";
import { evaluate, metrics } from "deepeval";
...
await evaluate([testCase], [new metrics.MultiTurnMCPUseMetric()]);
```
