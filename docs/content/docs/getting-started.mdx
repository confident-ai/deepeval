...
DeepEval also integrates natively with [Confident AI](https:/www.confident-ai.com), an AI quality platform for teams to collaborate with observability, evals, and monitoring.
