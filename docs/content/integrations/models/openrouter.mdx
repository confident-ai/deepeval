...
There are **ZERO** mandatory and **EIGHT** optional parameters when creating an `OpenRouterModel`:
...
- [Optional] `generationKwargs`: An object of additional generation parameters forwarded to OpenRouter's `chat.completions.create(...)` call.
