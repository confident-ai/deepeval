...
There are **ZERO** mandatory and **EIGHT** optional parameters when creating a `LocalModel`:
...
- [Optional] `generationKwargs`: An object of additional generation parameters forwarded to the local server's `chat.completions.create(...)` call.

:::tip
Any additional parameters you would like to use for your model can be passed through the generation kwargs parameter.
:::
