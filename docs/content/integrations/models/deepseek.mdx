...
There are **ZERO** mandatory and **SEVEN** optional parameters when creating a `DeepSeekModel`:
...
:::tip
Before passing additional generation parameters, we request you to double check the params supported by the model and your model provider in their [official docs](https://api-docs.deepseek.com/api/create-chat-completion#request).
:::
