...
There are **ZERO** mandatory and **EIGHT** optional parameters when creating a `GrokModel`:
...
:::tip
Any additional parameters you would like to use for your model can be passed through the generation kwargs parameter. However, we request you to double check the params supported by the model and your model provider in their [official docs](https://docs.x.ai/docs/guides/function-calling#function-calling-modes).
:::
