...
- **Confident AI** is the **enterprise AI quality platform**: LLM observability, online evaluation, monitoring, cloud-hosted datasets, prompt and model experimentation, shared regression reports, and team collaboration.
...
DeepEval also pairs with **DeepTeam**, our open-source red teaming package, when you scale to LLM safety and security testing.
...
If you want evaluation plus an enterprise platform with observability, monitoring, and team collaboration, pair DeepEval with [Confident AI](https://confident-ai.com) — the separate enterprise platform from the same team. DeepEval and Confident AI are not the same product: DeepEval is the open-source framework, Confident AI is the enterprise platform you graduate into when team scale demands it. That should be more than enough to get started with DeepEval.
