...
If you want to define the decision points yourself instead of using Jev inside an existing metric, read [Introducing JevEval](/blog/introducing-jev-as-a-judge). It shows how to build a custom Jev-as-a-Judge metric from Noul, Score, and Choice questions, with a complete probability-level score breakdown.
