...
We wrote a separate post on it: [Introducing JevEval: Jev-as-a-Judge for LLM Evaluation](/blog/introducing-jev-as-a-judge) walks through building a Tool Faithfulness metric, question by question, down to every probability. There is a [`ConversationalJevEval`](/docs/metrics-conversational-jev-eval) for multi-turn test cases too.
