...
- Use [`JevEval`](/blog/introducing-jeveval) when you can express a custom metric as explicit bounded questions and want the score calculated with fixed math.
...
[`JevEval`](/blog/introducing-jeveval) lets you define those decisions as three bounded question types:
...
- Use [`JevEval`](/blog/introducing-jeveval) when the rubric can be decomposed into bounded questions and you do not need an LLM to generate the judgement.
...
- Read [Introducing JevEval](/blog/introducing-jeveval) to build a custom Jev-as-a-Judge metric from bounded questions.
