...
If you also need an enterprise platform on top of evaluation — with observability, monitoring, online evals, and team collaboration — DeepEval pairs natively with [Confident AI](https://confident-ai.com), the separate enterprise platform from the same team. DeepEval and Confident AI are not the same product: DeepEval is the open-source framework, Confident AI is the enterprise platform you graduate into when team scale demands it.
