...
- [Custom metrics](https://deepeval.com/docs/metrics-llm-evals) — Allows for tailored evaluation criteria based on domain-specific needs, such as empathy, safety, or tone.
...
- [Medical Assistant Quality](https://deepeval.com/docs/metrics-llm-evals): A custom metric that evaluates the overall conversational quality.
