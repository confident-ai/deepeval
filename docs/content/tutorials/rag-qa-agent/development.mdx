...
:::note
If you already have a RAG application that you want to evaluate, feel free to skip to the [**evaluation section of this tutorial**](/tutorials/rag-qa-agent/evaluation).
:::
...
In the next section, we'll see [how to evaluate our RAG QA Agent](/tutorials/rag-qa-agent/evaluation) using `deepeval`.