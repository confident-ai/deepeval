...
Under-the-hood, the `TurnRelevancyMetric` loops through each assistant turn and uses a **sliding window approach** to construct a series of **"unit interactions" as historical context** for evaluation. [Click here](/docs/metrics-turn-relevancy) to learn more about the `TurnRelevancyMetric` and how it is calculated.
...
[Click here](/docs/metrics-turn-relevancy) to learn more about the `TurnRelevancyMetric` and how it is calculated.
