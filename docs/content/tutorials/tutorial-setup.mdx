...
const testCase = new LLMTestCase({
  input: "I have a persistent cough and fever. Should I be worried?",
  // Replace this with the actual output from your LLM application
  actualOutput: "A persistent cough and fever could signal various illnesses, from minor infections to more serious conditions like pneumonia or COVID-19. It's advisable to seek medical attention if symptoms worsen, persist beyond a few days, or if you experience difficulty breathing, chest pain, or other concerning signs.",
