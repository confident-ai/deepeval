...
In September, the release focused on enhancing integration reliability and compatibility. OpenTelemetry integrations now serialize `tools_called` and `expected_tools` attributes correctly, resulting in more consistent trace data. The Pydantic AI integration was updated to support both 1.x and 2.x versions, improving agent instrumentation and ensuring accurate extraction and validation of tool arguments and results.

### Improvement

#### v4.2.2
- Improve compatibility with Pydantic AI by updating integration and documentation to support both 1.x and 2.x versions, including correct handling of agent instrumentation and tool argument/result extraction. Fixes issues with field validation and ensures tool data is properly captured for evaluations. ([#3252](https://github.com/confident-ai/deepeval/pull/3252)) {/* pr:3252 */} ([Jeffrey Ip](https://github.com/penguine-ip))


### Bug Fix

#### v4.2.2
- Fix application of tools_called and expected_tools fields in OpenTelemetry integrations to ensure correct attribute serialization and improved trace data consistency. ([#3103](https://github.com/confident-ai/deepeval/pull/3103)) {/* pr:3103 */} ([Vamshi Adimalla](https://github.com/A-Vamshi))



## August

August brought significant improvements to the developer tool, focusing on enhanced evaluation workflows, expanded TypeScript support, and better onboarding experiences. Key metrics were updated to align with standard scoring conventions, and new features such as voice conversation simulations and component-level evaluations were introduced. The release also addressed numerous usability and reliability issues, including improved dataset management, stricter type checking, and more robust handling of edge cases in metrics and data serialization. Documentation and onboarding were refined to ensure clarity and ease of use, making the tool more accessible and powerful for both Python and TypeScr
...
June's release brings major enhancements to both Python and TypeScript interfaces, expanding support for new evaluation models, including Gemini 3 and Claude Opus 4-8, with improved multimodal and structured output capabilities. The update introduces dataset versioning, more flexible context generation across multiple files, and comprehensive token and cost tracking for greater transparency. Usability improvements include a new governance command, relaxed test file naming, and better project organization, while extensive documentation updates and numerous bug fixes ensure a smoother and more reliable experience for users working with diverse LLM providers and evaluation scenarios.
...
April's release focused on streamlining configuration and improving model support, with legacy options removed and new features added for both OpenAI and Anthropic models, including multimodal and structured output capabilities. The introduction of a `generate` CLI command and prompt branch management enhances dataset creation and versioning workflows. Tracing and evaluation workflows saw significant upgrades, with expanded metadata support, improved trace correlation, and new guides for advanced use cases. Documentation and CI infrastructure were modernized, and numerous bug fixes addressed issues in tracing, schema handling, and golden data round-tripping, resulting in a more robust and up
...
March brought major improvements to observability and integration, with expanded support for OpenTelemetry and OpenInference, enabling detailed tracing and metric collection for agents, tools, and LLMs. The release focused on reliability and correctness, addressing issues in async evaluation, trace propagation, and provider configuration, while also enhancing test stability and memory management for large-scale runs. Documentation and configuration options were updated to support new features and integrations, making it easier for users to adopt Amazon Bedrock, AWS AgentCore, and multiple evaluation providers. Numerous bug fixes and refinements ensure more accurate metrics, robust error-hand
...
February's release focused on enhancing tool and prompt support, with significant improvements to schema handling and prompt versioning. The update introduced more flexible cache directory management and expanded regional support for Confident AI requests. Numerous bug fixes addressed issues in tracing, prompt metadata, and compatibility with external services, while dependency management was refined to reduce installation friction. Overall, these changes improve reliability, developer experience, and cross-platform robustness.
...
January saw major improvements in model integration, authentication, and documentation across the tool. New support for OpenRouter and Azure AD authentication expands model and provider compatibility, while enhancements to tracing, metric collection, and error handling make integrations with LangChain, LangGraph, and Pydantic AI more robust and reliable. The release also introduces an automated changelog generator and updates documentation for clarity and easier navigation. Numerous bug fixes and usability improvements ensure more predictable behavior, clearer error messages, and better support for multimodal and batch evaluation workflows.
