...
<ColabButton 
  notebookUrl="https://colab.research.google.com/github/confident-ai/deepeval/blob/main/examples/notebooks/pydantic_ai.ipynb" 
...
```python title="main.py" showLineNumbers {8}
