...
- automatically integrates with [Confident AI](https://www.confident-ai.com/docs), which offers evaluation analysis, evaluation debugging, dataset management, and real-time evaluations in production
