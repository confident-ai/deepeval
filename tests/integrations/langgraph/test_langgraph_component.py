...
workflow.add_conditional_edges("llm", route_messages, {"tools": "tools", END: END})
...
if __name__ == "__main__":
    inputs = {"messages": [{"role": "user", "content": "What is the weather in London?"}]}
    result = app.invoke(inputs, config={"callbacks": [CallbackHandler(
