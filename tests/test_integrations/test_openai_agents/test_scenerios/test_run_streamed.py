...
async def test_json_schema():
    ...
    """
    expected_temp_path = '../trace_dump/temp_run_streamed.json'
    actual_temp_path = '../trace_dump/run_streamed.json'
