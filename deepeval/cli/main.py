...
from deepeval.cli.providers import (
...
register_set_command(app, "set-openai")
register_unset_command(app, "unset-openai")
...
register_set_command(app, "set-azure-openai")
register_unset_command(app, "unset-azure-openai")
...
register_set_command(app, "set-azure-openai-embedding")
register_unset_command(app, "unset-azure-openai-embedding")
...
register_set_command(app, "set-anthropic")
register_unset_command(app, "unset-anthropic")
...
register_set_command(app, "set-bedrock")


register_unset_command(app, "unset-bedrock")
...
register_set_command(app, "set-ollama")
register_unset_command(app, "unset-ollama")
...
register_set_command(app, "set-ollama-embeddings")
register_unset_command(app, "unset-ollama-embeddings")
...
register_set_command(app, "set-local-model")
register_unset_command(app, "unset-local-model")
...
register_set_command(app, "set-grok")
register_unset_command(app, "unset-grok")
...
register_set_command(app, "set-moonshot")
register_unset_command(app, "unset-moonshot")
...
register_set_command(app, "set-deepseek")
register_unset_command(app, "unset-deepseek")
...
register_set_command(app, "set-local-embeddings")
register_unset_command(app, "unset-local-embeddings")
...
register_set_command(app, "set-gemini")
register_unset_command(app, "unset-gemini")
...
register_set_command(app, "set-litellm")
register_unset_command(app, "unset-litellm")
...
register_set_command(app, "set-portkey")
register_unset_command(app, "unset-portkey")
...
register_set_command(app, "set-openrouter")
register_unset_command(app, "unset-openrouter")
