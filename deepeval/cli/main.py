...
def login(
    ...
    with capture_login_event() as span:
        ...
        try:
            ...
            print(
                "You're now using DeepEval with [rgb(106,0,255)]Confident AI[/rgb(106,0,255)]. Follow our quickstart tutorial here: [bold][link=https://documentation.confident-ai.com/docs/getting-started/installation]https://documentation.confident-ai.com/docs/getting-started/installation[/link][/bold]"
            )
        except:
