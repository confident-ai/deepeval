...
def set_openai_env(
    ...
    KEY_FILE_HANDLER.write_key(
        KeyValues.USE_OPENAI_MODEL, "YES"
    )
    KEY_FILE_HANDLER.write_key(
        KeyValues.OPENAI_MODEL_NAME, model
    )
    KEY_FILE_HANDLER.write_key(
        KeyValues.OPENAI_COST_PER_INPUT_TOKEN, str(cost_per_output_token)
    )
    KEY_FILE_HANDLER.write_key(KeyValues.OPENAI_COST_PER_OUTPUT_TOKEN, str(cost_per_input_token))
    print(
