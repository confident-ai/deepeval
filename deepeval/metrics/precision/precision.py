...
class PrecisionMetric(BaseMetric):
    ...
    def measure(
        ...
        with metric_progress_indicator(
            ...
            self.score, expected_tokens, actual_tokens, matched_tokens = self._compute_precision(expected, actual)
            self.reason = (
            ...
            if self.verbose_mode:
                self.verbose_logs = construct_verbose_logs(
                    self,
                    steps=[
                        f"Precision Score: {self.score:.2f}",
    ...
    def _compute_precision(
        ...
        return precision, expected_tokens, actual_tokens, overlap_tokens
