...
class MultimodalFaithfulnessTemplate:
    ...
    def generate_reason(score, contradictions):
        return textwrap.dedent(
            f"""Below is a list of Contradictions. It is a list of strings explaining why the 'generated output' does not align with the information presented in the 'retrieval context'. Contradictions happen in the 'generated output', NOT the 'retrieval context'.
