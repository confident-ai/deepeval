...
from deepeval.metrics.image_helpfulness.template import ImageHelpfulnessTemplate
...
from deepeval.metrics.image_helpfulness.schema import ReasonScore
        ...
        with metric_progress_indicator(self, _show_indicator=_show_indicator):
            if self.async_mode:
                ...
                for image_index in self.get_image_indices(actual_output):
                    ...
                    score, reason = self.evaluate_image_helpfulness(image, context_above, context_below)
                    score = score / 10
    ...
    async def a_measure(
        ...
        with metric_progress_indicator(
            ...
            for image_index in image_indices:
                ...
                image = actual_output[image_index]
                tasks.append(
                    self.a_evaluate_image_helpfulness(image, context_above, context_below)
                )
