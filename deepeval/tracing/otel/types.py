...
class ConfidentLlmInputMessage(BaseModel):
    confident_system_message: Optional[str] = Field(default=None) # gen_ai.system.message
    confident_user_message: Optional[str] = Field(default=None) # gen_ai.user.message
    confident_assistant_message: Optional[str] = Field(default=None) # gen_ai.assistant.message
...
class ConfidentLlmSpan(BaseConfidentGenAiOperationSpan):
    ...
    confident_request_model: Optional[str] = Field(default=None) # gen_ai.request.model
    ...
    confident_usage_input_tokens: Optional[int] = Field(default=None) # gen_ai.usage.input_tokens
    confident_usage_output_tokens: Optional[int] = Field(default=None) # gen_ai.usage.output_tokens
