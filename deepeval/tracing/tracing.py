...
class TraceManager:
    ...
    def create_trace_api(self, trace: Trace) -> TraceApi:
        ...
        trace_api = TraceApi(
            ...
            endTime=end_time,
            metadata=make_json_serializable(trace.metadata),
            name=trace.name,
            tags=trace.tags,
            threadId=trace.thread_id,
            userId=trace.user_id,
            input=make_json_serializable(trace.input),
            output=make_json_serializable(trace.output),
    ...
    def _convert_span_to_api_span(self, span: BaseSpan) -> BaseApiSpan:
        ...
        api_span = BaseApiSpan(
            ...
            startTime=start_time,
            endTime=end_time,
            input=make_json_serializable(input_data),
            output=make_json_serializable(output_data),
            metadata=make_json_serializable(span.metadata),
            error=span.error,
