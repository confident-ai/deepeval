...
class Observer:
    ...
    def create_span_instance(self):
        ...
        if self.span_type == SpanType.AGENT.value:
            ...
            cost_per_input_token = self.observe_kwargs.get("cost_per_input_token", None)
            cost_per_output_token = self.observe_kwargs.get("cost_per_output_token", None)
            ...
            return LlmSpan(**span_kwargs, attributes=None, model=model, cost_per_input_token=cost_per_input_token, cost_per_output_token=cost_per_output_token)
