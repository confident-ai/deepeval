...
class COPRORunner:
    ...
    - Uses mini-batches of goldens for trial scoring and a simple surrogate
      over prompt candidates (epsilon-greedy selection on mean minibatch
      scores), extended with cooperative proposals:
    ...
    def __init__(
        ...
        *,
        ...
        # surrogate style candidate selection.
