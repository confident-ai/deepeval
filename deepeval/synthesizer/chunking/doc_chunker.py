...
class DocumentChunker:
    ...
    async def a_chunk_doc(self) -> List[LCDocument]:
        ...
        try:
            ...
            collection = client.create_collection(name=f"processed_chunks_{self.chunk_size}_{self.chunk_overlap}")
            langchain_chunks: List[LCDocument] = self.text_splitter.split_documents(self.sections)
