...
class RTUnalignedVulnerabilities(Enum):
    ...
    HARMFUL_CYBERCRIME = 'Cybercrime & Unauthorized Intrusion - Hacking and Malware'
...
class RTVulnerability(Enum):
    ...
    HARMFUL_MISINFORMATION_DISINFORMATION = 'Misinformation & Disinformation - Harmful lies and propaganda'
    ...
    HARMFUL_VIOLENT_CRIME = RTUnalignedVulnerabilities.HARMFUL_VIOLENT_CRIME.value
    HARMFUL_NON_VIOLENT_CRIME = RTUnalignedVulnerabilities.HARMFUL_NON_VIOLENT_CRIME.value
    HARMFUL_SEX_CRIME = RTUnalignedVulnerabilities.HARMFUL_SEX_CRIME.value
    HARMFUL_CHILD_EXPLOITATION = RTUnalignedVulnerabilities.HARMFUL_CHILD_EXPLOITATION.value
    HARMFUL_INDISCRIMINATE_WEAPONS = RTUnalignedVulnerabilities.HARMFUL_INDISCRIMINATE_WEAPONS.value
    ...
    HARMFUL_SEXUAL_CONTENT = RTUnalignedVulnerabilities.HARMFUL_SEXUAL_CONTENT.value
    HARMFUL_CYBERCRIME = RTUnalignedVulnerabilities.HARMFUL_CYBERCRIME.value
    HARMFUL_CHEMICAL_BIOLOGICAL_WEAPONS = RTUnalignedVulnerabilities.HARMFUL_CHEMICAL_BIOLOGICAL_WEAPONS.value
    HARMFUL_ILLEGAL_DRUGS = RTUnalignedVulnerabilities.HARMFUL_ILLEGAL_DRUGS.value
    HARMFUL_COPYRIGHT_VIOLATIONS = RTUnalignedVulnerabilities.HARMFUL_COPYRIGHT_VIOLATIONS.value
    HARMFUL_HARASSMENT_BULLYING = RTUnalignedVulnerabilities.HARMFUL_HARASSMENT_BULLYING.value
    HARMFUL_ILLEGAL_ACTIVITIES = RTUnalignedVulnerabilities.HARMFUL_ILLEGAL_ACTIVITIES.value
    HARMFUL_GRAPHIC_CONTENT = RTUnalignedVulnerabilities.HARMFUL_GRAPHIC_CONTENT.value
    HARMFUL_UNSAFE_PRACTICES = RTUnalignedVulnerabilities.HARMFUL_UNSAFE_PRACTICES.value
    HARMFUL_RADICALIZATION = RTUnalignedVulnerabilities.HARMFUL_RADICALIZATION.value
