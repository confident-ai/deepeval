...
class SpanInterceptor(SpanProcessor):
    ...
    def on_start(self, span, parent_context):
        ...
        if self.settings.confident_prompt:
            span.set_attribute(
                "confident.span.prompt_alias", self.settings.confident_prompt.alias
            )
            span.set_attribute(
                "confident.span.prompt_commit_hash", self.settings.confident_prompt.hash
            )
            span.set_attribute(
                "confident.span.prompt_label", self.settings.confident_prompt.label
            )
            span.set_attribute(
                "confident.span.prompt_version", self.settings.confident_prompt.version
            )
