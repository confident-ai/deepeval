...
class ModelKeyValues(Enum):
    ...
    # OrcaRouter
    USE_ORCAROUTER_MODEL = "USE_ORCAROUTER_MODEL"
    ORCAROUTER_MODEL_NAME = "ORCAROUTER_MODEL_NAME"
    ORCAROUTER_COST_PER_INPUT_TOKEN = "ORCAROUTER_COST_PER_INPUT_TOKEN"
    ORCAROUTER_COST_PER_OUTPUT_TOKEN = "ORCAROUTER_COST_PER_OUTPUT_TOKEN"
