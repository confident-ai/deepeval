...
class ModelKeyValues(Enum):
    ...
    # CometAPI
    USE_COMETAPI_MODEL = "USE_COMETAPI_MODEL"
    COMETAPI_KEY = "COMETAPI_KEY"
    COMETAPI_MODEL_NAME = "COMETAPI_MODEL_NAME"
...
class EmbeddingKeyValues(Enum):
    ...
    # CometAPI
    USE_COMETAPI_EMBEDDING = "USE_COMETAPI_EMBEDDING"
    COMETAPI_EMBEDDING_MODEL_NAME = "COMETAPI_EMBEDDING_MODEL_NAME"
    # Local
