...
class ModelKeyValues(Enum):
    ...
    # Atlas Cloud
    USE_ATLASCLOUD_MODEL = "USE_ATLASCLOUD_MODEL"
    ATLASCLOUD_MODEL_NAME = "ATLASCLOUD_MODEL_NAME"
    ATLASCLOUD_COST_PER_INPUT_TOKEN = "ATLASCLOUD_COST_PER_INPUT_TOKEN"
    ATLASCLOUD_COST_PER_OUTPUT_TOKEN = "ATLASCLOUD_COST_PER_OUTPUT_TOKEN"
