"""Renderers specific to the OpenAI Responses API.

The Chat-Completions-shaped helpers live in `deepeval.model_integrations.utils`
because every OpenAI-compatible provider shares that wire format.
"""
