...
def _patch_default_agent_runner_get_model():
    ...
    def _patched_get_model(cls, *args, **kwargs) -> Model:
    ...
    _patched_get_model.__name__ = original_get_model.__name__
    _patched_get_model.__doc__ = original_get_model.__doc__

    AgentRunner._get_model = classmethod(_patched_get_model)
