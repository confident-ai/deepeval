...
# OrcaRouter is reached through the OpenAI SDK (OpenAI-compatible gateway), so
# it raises the same exception classes and shares OpenAI's retry classification.
ORCAROUTER_ERROR_POLICY = OPENAI_ERROR_POLICY
...
_POLICY_BY_SLUG: dict[str, Optional[ErrorPolicy]] = {
    ...
    PS.ORCAROUTER.value: ORCAROUTER_ERROR_POLICY,
...
_STATIC_PRED_BY_SLUG: dict[str, Optional[Callable[[Exception], bool]]] = {
    ...
    PS.ORCAROUTER.value: _opt_pred(ORCAROUTER_ERROR_POLICY),
