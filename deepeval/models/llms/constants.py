...
OPENAI_MODELS_DATA = ModelDataRegistry(
    {
        ...
        # Non-reasoning chat variant: unlike the o-series / gpt-5 reasoning
        # models in this block, it accepts a custom temperature. Set the flag
        # explicitly (it defaults to True) so the omission is not mistaken for
        # a bug and "fixed" to False.
...
GEMINI_MODELS_DATA = ModelDataRegistry(
    {
        ...
        "gemini-3.1-pro-preview": make_model_data(
            supports_log_probs=False,
            supports_multimodal=True,
            supports_structured_outputs=True,
            supports_json=True,
        ...
        "gemini-3-flash-preview": make_model_data(
            ...
            supports_json=True,
            input_price=0.5 / 1e6,
            output_price=3.0 / 1e6,
        ),
        "gemini-3.1-flash-lite": make_model_data(
            supports_log_probs=False,
            supports_multimodal=True,
            supports_structured_outputs=True,
            supports_json=True,
            input_price=0.25 / 1e6,
            output_price=1.5 / 1e6,
        ),
