...
class TestRunManager:
    ...
    def display_results_table(
        ...
        column_config = dict(justify="left", max_width=COLUMN_MAX_WIDTH, no_wrap=False)
        ...
        # Process conversational test cases
        for index, conversational_test_case in enumerate(test_run.conversational_test_cases):
