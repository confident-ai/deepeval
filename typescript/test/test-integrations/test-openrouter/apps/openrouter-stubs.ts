// Wire-shaped OpenRouter responses for the two offline suites in this
// directory: `openrouter-sdk.test.ts` (native SDK) and
// `openrouter-openai-route.test.ts` (OpenAI SDK).
//
...
// camelCases it on the way in. Deriving both suites' payloads from one body is
// what gets both casings exercised against the same wire shape.
