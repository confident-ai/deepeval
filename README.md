...
- Easily benchmark **ANY** LLM on popular LLM benchmarks such as MMLU, HellaSwag, and BIG-Bench Hard in [under 10 lines of code.](https://docs.confident-ai.com/docs/benchmarks-introduction)
